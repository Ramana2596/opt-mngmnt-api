// getOpsDiscountOfferInfo.js
// Purpose: Fetch Discount Offer by Strategy
...
router.post('/getOpsDiscountOfferInfo', async (req, res) => {
  try {
    ...
    const result = await request.execute('UI_Ops_Discount_Offer_Info');
