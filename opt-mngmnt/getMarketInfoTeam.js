// getMarketInfoTeam.js
// Purpose: Fetch Market Input published to a Team 
...
router.post('/getMarketInfoTeam', async (req, res) => {
  try {
    ...
    const result = await request.execute('UI_Market_Info_Team');
