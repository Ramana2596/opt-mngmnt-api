// getIncomeStatementInfo.js
// Purpose: fetch Income Statement
...
router.post('/getIncomeStatementInfo', async (req, res) => {
  try {
    ...
    const result = await request.execute('UI_Income_Statement_Dynamic');
